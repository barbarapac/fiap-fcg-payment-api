    ...
    where TRequest : notnull
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation("Processamento da requisi��o iniciado");
        ...
        try
        {
            ...
            _logger.LogInformation(
                "Processamento da requisi��o conclu�do. DuracaoMs: {DuracaoMs}",
        ...
        catch (Exception ex)
        {
            ...
            _logger.LogError(
                ex,
                "Falha no processamento da requisi��o. DuracaoMs: {DuracaoMs}",
                sw.ElapsedMilliseconds);
