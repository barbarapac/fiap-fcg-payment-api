...
COPY ["src/Fiap.FCG.Payment.Application/Fiap.FCG.Payment.Application.csproj", "src/Fiap.FCG.Payment.Application/"]
COPY ["src/Fiap.FCG.Payment.Domain/Fiap.FCG.Payment.Domain.csproj", "src/Fiap.FCG.Payment.Domain/"]
COPY ["src/Fiap.FCG.Payment.Infrastructure/Fiap.FCG.Payment.Infrastructure.csproj", "src/Fiap.FCG.Payment.Infrastructure/"]
COPY ["src/Fiap.FCG.Payment.WebApi/Fiap.FCG.Payment.WebApi.csproj", "src/Fiap.FCG.Payment.WebApi/"]
...
RUN dotnet publish "src/Fiap.FCG.Payment.WebApi/Fiap.FCG.Payment.WebApi.csproj" \
    -c Release \
    -o /app/publish \
    /p:UseAppHost=false \
